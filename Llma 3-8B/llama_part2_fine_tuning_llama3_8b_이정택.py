# -*- coding: utf-8 -*-
"""llama_part2_Fine_Tuning_llama3-8B_이정택.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1hqXTWfpUzR9cqY2z8wBaMFauYIS3dBmJ
"""
...
if inColab == True:
    !pip install -U pandas==2.2.2 numpy==1.26.4 scipy==1.14.1 accelerate==1.6.0 peft==0.15.2 bitsandbytes==0.45.5 transformers==4.51.3 trl==0.16.1 datasets==3.5.0 tensorboard==2.19.0
...
# # -U 옵션: 지정된 패키지가 이미 설치되어 있는 경우에도 최신 버전으로 업그레이드
if inColab == True:
     !pip install -U accelerate==0.32.1 peft==0.12.0 bitsandbytes==0.43.3 transformers==4.44.2 trl==0.9.6 tensorboard==2.17.1
...
# base_model = "meta-llama/Meta-Llama-3-8B-Instruct" # 교수님 버전
base_model = "meta-llama/Meta-Llama-3-8B-Instruct" # 3-8b 버전
...
question = "유튜브 채널 hkcode는 누가 운영하나요?"
...
# if inColab == True:
#     savePath = f"/content/gdrive/MyDrive/Colab Notebooks/data_edu/16. LLM 파인튜닝/models/tune_{now_str}"
